...
import AdvancedFilters from "../../../features/catalog/filters/ui/AdvancedFilters.jsx";
import { QUICK_TAGS } from "../../../shared/config/constants.js";
import ProductCard from "../../../entities/product/ui/ProductCard.jsx";
import {
  searchProducts,
  getProductsFeed } from
"../../../shared/api/catalog.js";

export default function FYP({ role, buyerType, garage, setSelectedProduct, navigateTo, onAddToCart }) {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    {}
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6 items-stretch">
                        {products.map((p) =>
          <ProductCard
            key={p.id}
            product={p}
